...
const QA = () => {
  return (
    <div className="flex flex-col items-center justify-center  bg-gradient-to-b from-slate-50 to-blue-50 min-h-[60vh]">
      <div className="grid md:grid-cols-2 max-w-screen-xl  mx-auto items-center justify-center auto-rows-max text-center md:text-left gap-4  py-8 px-4">
        <div>
          <span className="text-palette-ext text-xl font-bold">
            SCHOOL TREP Q&A
          </span>
          <h2 className="text-palette-primary font-bold text-3xl">
          ...
          <p>
            ...
            usted y su hijo se sientan como en casa con nosotros, por lo que
            hemos creado una lista de las preguntas más frecuentes sobre la
            compra de sus útiles escolares.
            <br />
            <br />
        ...
        <div className="flex flex-col gap-2">
          <Question title="Soy una escuela.¿Cómo puedo trabajar con Schooltrep?">
            ...
            <a
              href="mailto:school@trep.com.mx"
          ...
          <Question title="Tiempo de entraga estimado">
            ...
            Viernes.
            <br />
            Una vez que el pedido se procesa, el paquete se mandará en la
            ...
            <br />
            <span className="text-xs py-2 font-bold text-palette-second">
          ...
          <Question title="¿Tienen pagos a Meses sin intereses?">
            Sí, para esta forma de pago, contamos con programas de pagos
            diferidos desde 3 hasta 18 meses sin intereses.
          </Question>
        </div>
      </div>
    </div>
